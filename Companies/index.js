...
router.get("/id/:id", (0, express_validator_1.param)("id").notEmpty().isNumeric(), validator_1.validator, (request, response) => {
    ...
    Companies_1.default.getById(id)
        .then((companie) => {
        if (companie === null) {
            response.status(400).json({
...
router.post("/", (0, express_validator_1.body)("fantasy_name").isLength({ min: 5, max: 191 }), (0, express_validator_1.body)("contact").isLength({ min: 5, max: 191 }), (0, express_validator_1.body)("cnpj").isLength({ min: 18, max: 19 }), (0, express_validator_1.body)("tel").isLength({ min: 19, max: 19 }), (0, express_validator_1.body)("email").isLength({ min: 5, max: 255 }).isEmail(), (0, express_validator_1.body)("address").isLength({ min: 5, max: 191 }), (0, express_validator_1.body)("city").isLength({ min: 5, max: 191 }), (0, express_validator_1.body)("uf").isLength({ min: 2, max: 2 }), (0, express_validator_1.body)("password").isLength({ min: 5, max: 30 }), validator_1.validator, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Companies_1.default.create(companieValues)
        ...
        const mailOptions = Mailer_1.default.createMailOptions(companie.email, "Sucesso ao cadastrar a sua empresa no sistema currícular do CRCGO", Companies_1.default.createMailCompanieHTML(companie));
